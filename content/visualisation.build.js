/*!  name:viz/visualisation - STAGE - version: 1029 */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getContentComponent", function() { return getContentComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createComponentFilename", function() { return createComponentFilename; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createComponentElement", function() { return createComponentElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createComponentAsset", function() { return createComponentAsset; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createComponentVisualisation", function() { return createComponentVisualisation; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_js_amplience_content_service__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content_types__ = __webpack_require__(183);



var _this = this;

/* eslint-disabe no-unused-expressions */



var getQueryVar = function getQueryVar(url, queryVariable) {
  var query = url.substring(1);
  var variables = query.split('&');
  var queryVariableValue = null;

  variables.forEach(function (variable) {
    var pair = variable.split('=');
    if (decodeURIComponent(pair[0]) === queryVariable) {
      queryVariableValue = decodeURIComponent(pair[1]);
    }
  });
...
var getContentType = function () {
  var _ref = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(url) {
    var content, res, contentType;
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            content = new __WEBPACK_IMPORTED_MODULE_2__assets_js_amplience_content_service__["a" /* default */]('https://' + getQueryVar(url, 'src'));
            _context.next = 3;
          ...
          case 3:
            ...
            res['@type'] ? contentType = res['@type'] : contentType = { error: true };
  ...
  return function getContentType(_x) {
...
var getContentComponent = function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            contentTypeId = contentType.split('/')[3];
            return _context2.abrupt('return', __WEBPACK_IMPORTED_MODULE_3__content_types__["a" /* default */][contentTypeId]);
  ...
  return function getContentComponent(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

var createComponentFilename = function createComponentFilename(component) {
  return component.filename + '.build.js';
};

var createComponentElement = function createComponentElement(component) {
  var componentElement = document.createElement('div');
  componentElement.id = component.el;
  componentElement.setAttribute('data-content', 'https:' + getQueryVar(window.location.search, 'src'));

  return componentElement;
};

var createComponentAsset = function createComponentAsset(component) {
  var componentScript = document.createElement('script');
  componentScript.src = 'https://cdn.halfords-content.com/content/stage/' + createComponentFilename(component);

  return componentScript;
};

var createComponentVisualisation = function () {
  var _ref3 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(url) {
    var component, componentElement, componentAssetJS;
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getContentComponent(url);

          case 2:
            component = _context3.sent;
            componentElement = createComponentElement(component);
            componentAssetJS = createComponentAsset(component);


            document.getElementById('visualisation').appendChild(componentElement);
            document.getElementsByTagName('head')[0].appendChild(componentAssetJS);
  ...
  return function createComponentVisualisation(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

createComponentVisualisation(window.location.search);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  'fac2439a-061b-476b-97ad-2855a6c2e156': {
    filename: 'slider',
    el: 'amp-ca-slider'
  },
  '2789e78b-61a5-495f-9da4-589e98887ab5': {
    filename: 'image',
    el: 'amp-ca-image'
  }
});
