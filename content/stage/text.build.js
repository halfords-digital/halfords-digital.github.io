/*!  name:components/text - STAGE - version: 1136 */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__text_content__ = __webpack_require__(242);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    style: function style() {
      return {
        color: this.textContent.colour,
        fontSize: this.textContent.fontSize + 'px',
        textTransform: this.textContent.isUppercase ? 'uppercase' : 'none',
        fontFamily: this.textContent.font
      };
    }
  },
  created: function created() {
    if (this.hasContentUrl) {
      textContent = new __WEBPACK_IMPORTED_MODULE_0__text_content__["a" /* default */](this.content);
    }
  },
  beforeMount: function beforeMount() {
    if (this.hasContentUrl) {
      var vm = this;
      textContent.formatTextContent().then(function () {
        vm.textContent = textContent.content;
      }, function () {
        vm.hasError = true;
      });
    } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Text__ = __webpack_require__(241);
...
new Vue({
  ...
  render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_0__Text__["a" /* default */], {
      props: {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Text_vue__ = __webpack_require__(162);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3e24b18f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Text_vue__ = __webpack_require__(243);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3e24b18f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Text_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/text/Text.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3e24b18f", Component.options)
  } else {
    hotAPI.reload("data-v-3e24b18f", Component.options)
  }
...
"use strict";
/* unused harmony export makeText */
...
var makeText = function makeText(_ref) {
  var text = _ref.text,
...
var TextContentService = function (_ContentService) {
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(TextContentService, _ContentService);

  function TextContentService() {
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, TextContentService);

    return __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (TextContentService.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(TextContentService)).apply(this, arguments));
  }

  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(TextContentService, [{
    key: 'formatTextContent',
    value: function formatTextContent() {
      var _this2 = this;

      return this.getContent().then(function (formatted) {
        _this2.content = makeText(formatted);
      });
    }
  }]);
...
/* harmony default export */ __webpack_exports__["a"] = (TextContentService);
...
var render = function() {
  ...
  return _c("p", { style: _vm.style }, [_vm._v(_vm._s(_vm.textContent.text))])
}
var staticRenderFns = []
